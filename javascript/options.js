...
<script>
  ...
  ga('send', 'pageview');
    ...
    <title>Options - Google Chrome</title>
  </head>

  <body>
    <div id="gc-container">
    <a href="options.js#gc-pagecontent" class="element-invisible element-focusable">Skip to main content</a>
...
<p>Use the <a href="../extensions/storage.html">storage</a> API to persist these preferences. These values will then become accessible in any script within your extension.</p>
...
<li>We plan on providing some default css styles to encourage a consistent look across different extensions' options pages. You can star <a href="http://crbug.com/25317">crbug.com/25317</a> to be notified of updates.</li>
    ...
    <h3>Contents</h3>
    <ol class="toc">
      <li class="toplevel"><a data-list-item href="options.js#step_1"
          >Step 1: Declare your options page in the manifest</a>
      </li>
      <li class="toplevel"><a data-list-item href="options.js#step_2"
          >Step 2: Write your options page</a>
      </li>
      <li class="toplevel"><a data-list-item href="options.js#important_notes"
          >Important notes</a>
      </li>
    </ol>
</section>
    ...
    <footer id="gc-footer" role="contentinfo" class="span-full">
      <div class="g-section g-tpl-50-50">
        <div class="g-unit g-first">
          <nav class="links">
            <a href="https://www.google.com/">Google</a><a href="https://developers.google.com/site-terms">Terms of Service</a><a href="http://www.google.com/intl/en/privacy/">Privacy Policy</a><a href="options.js" data-feedback>Report a bug</a>
          </nav>
        </div>
